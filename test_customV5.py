...
from model_cnn_transv4_LG import Generator as GeneratorV2

# Argument Parser
parser = argparse.ArgumentParser(description='Super Resolution Processing with Comprehensive Metrics')
...
parser.add_argument('--model1_name', default='/CT_HYBRIDV4_4B_netG_epoch_4_85.pth', type=str, help='first generator model')
...
print("=" * 100)
print("Starting Super-Resolution Comparison with Comprehensive Metrics")
print("=" * 100)
...
csv_path = os.path.join(OUTPUT_FOLDER, "detailed_results_comprehensive.csv")
if results:
...
summary_csv_path = os.path.join(OUTPUT_FOLDER, "summary_results_comprehensive.csv")
...
# Example command:
# python test_customV5.py --test_folder "/home/dst/Desktop/GAN/SRGAN/Test_set" --output_folder "/home/dst/Desktop/GAN/SRGAN/output"
