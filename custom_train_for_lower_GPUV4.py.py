...
parser.add_argument('--file_name', default='Finalv2Xray_HYBRID_GAN_NIH_', type=str, help='Custom file name to be appended to the output')
...
if __name__ == '__main__':
    ...
    # hr_folder = "/home/dst/Desktop/GAN/SRGAN/data/wavlet/LL"Flickr2K/Flickr2K_HR
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        netG.eval()
        out_path = f'training_results/{FILE_NAME}_SRF_{str(UPSCALE_FACTOR)}_/'
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                for i in range(batch_size):
                    ...
                    sr_image = display_transform()(sr[i].cuda())
                    hr_image = display_transform()(hr[i].cuda())
        ...
        if epoch % 10 == 0:
            ...
            data_frame.to_csv(out_path + f'{FILE_NAME}_srf_{str(UPSCALE_FACTOR)}x_train_results.csv', index_label='Epoch')
