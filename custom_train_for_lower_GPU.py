...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('C:\\Users\\SOEE\\Documents\\GitHub\\SRGAN\\data\\HR_CT', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    val_set = ValDatasetFromFolder('C:\\Users\\SOEE\\Documents\\GitHub\\SRGAN\\data\\HR_CT_Val', upscale_factor=UPSCALE_FACTOR)
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                val_bar.set_description(
                    desc=f'[Converting LR to SR] PSNR: {valing_results["psnr"]:.4f} dB SSIM: {valing_results["ssim"]:.4f}')
